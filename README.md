...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/diffmah-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12718&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/diffmah-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `diffmah` can be installed with:

```
conda install diffmah
```

It is possible to list all of the versions of `diffmah` available on your platform with:
